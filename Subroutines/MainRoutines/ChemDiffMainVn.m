% ChemDiffMainVn
% A bc VN C bc VN
function [A,C,DidIBreak,SteadyState] = ChemDiffMainVn(ParamObj,TimeObj,AnalysisObj)
...
[Lop]    = LopMakerRdVn(Nx,dx,ParamObj.Bt,ParamObj.Kon,ParamObj.Koff,1,ParamObj.nu);
...
% keyboard
if ParamObj.SaveMe
    saveStr = sprintf('ConsVnNL%d_t%d',ParamObj.NLcoup,ParamObj.trial);
