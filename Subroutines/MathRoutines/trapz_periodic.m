function z = trapz_periodic(x,y,dim)
%MB 12-11-21 modify to apply to a periodic function,
%add interval between last point and first point
%x spacing between last and first point assumed the same 
%as x spacing between first and second point.
